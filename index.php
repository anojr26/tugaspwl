...
<html lang="en">
	<head> 
		<title>Aurelius Aliano Kraing</title>
		<meta charset="utf-8">
  		...
  		<div class="container-fluid">
  			...
  			switch(@$_GET['mod']) {
			      ...
			      <div class="blog-header">
			        <h1 class="blog-title">sistem informasi data pegawai </h1>
			        <p class="lead blog-description"> <a href='http://www.e-sutanto.blogspot.co.id' target='_blank'></a></p>
			      </div>
